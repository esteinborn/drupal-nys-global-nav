(function($, Drupal, window, document, undefined) {
  ...
  Drupal.behaviors.my_custom_behavior = {
    attach: function(context, settings) {
      ...
      console.log("Currently attaches class to #block-menu-block-16. This needs to change to something we create...  #menuwhatever");
      var customID = 'block-menu-block-16',
        blockID = '#' + customID,
        mainMenu = $(blockID).find('ul:not(.contextual-links)').first();
      $('.nys-global-header').prepend(
        '<div class="nav-toggle"><a href="#" role="button" id="nys-menu-control">Navigation menu</a></div>'
      );
      $.when(mainMenu.attr('id', 'nys-global-nav')).done(function() {
        ///$(document).ready(function() {
          console.log("Hello from main menu callback.");
          //   
          // #############   GLOBAL NAV BEHAVIORS   #################### //
          /*
          ClassList Polyfill
          ! @source http://purl.eligrey.com/github/classList.js/blob/master/classList.js */
          if ("document" in self) {
            console.log("Hello from document in self.");
            if (!("classList" in document.createElement("_"))) {
              console.log("Hello from createelement.");
              (function(j) {
                "use strict";
                if (!("Element" in j)) {
                  return
              ...
              console.log("I presume this error will fire until we get some kind of wrapper with the proper ID.");
              console.log("Also, we clearly need a Does This Exist? conditional for all of these.");
              (function() {
                ...
                if (b.classList.contains("c3")) {
                  ...
                  DOMTokenList.prototype.toggle = function(d, e) {
                    if (1 in arguments && !this.contains(d) ===
                      !e) {
                      return
                      e
                    } else {
      ...
      ! https://gist.githubusercontent.com/jonathantneal/3748027/raw/d262ccf278902705d61658a2fc5cd60409846b98/eventListener.polyfill.min.js*/
          !window.addEventListener && function(e, t, n, r, i, s,
            o) {
            ...
            e[r] = t[r] = n[r] = function(e, t) {
              ...
              for (var n = 0,
                ...
                if (r[0] == this && r[1] == e && r[2] == t)
                  return
              this.detachEvent("on" + e, o.splice(n, 1)[0]
                [
                  3
                ])
          ...
          var event = ('ontouchstart' in window) ?
            "touchend click" : "click";

            console.log("Hello from event listener callback.");
          ...
          function addListenerMulti(el, s, fn) {
            ...
            console.log("Hello from addListenerMulti.");
              var evts = s.split(' ');
          ...
          function listenSubMenu(i) {
              ...
              console.log("Hello from listenSubMenu.");
              addListenerMulti(menuLinks[i], event, function() {
                var l = this.parentNode.getElementsByTagName(
                  'ul')[0];
                if (l) {
                  toggleSubMenus(i);
                }
          ...
          function menuIsActive(child) {
            ...
            console.log("Hello from menuIsActive.");
          ...
          function toggleMainMenu(button) {
            ...
            console.log("Hello from toggleMainMenu.");
            if (menuList.classList.contains('active')) {

              console.log("Hello from menu active.");
              // Remove active class for main menu
              menuList.classList.remove('active');
              menuToggle.classList.remove('active');
            } else {
              console.log("Hello from menu not active.");
            ...
            for (var i = 0; i < menuItems.length; i++) {
              console.log("Hello from removing active hidden.");
          ...
          function toggleSubMenus(item) {
            ...
            if (menuItems[item].classList.contains('active')) {
              ...
              active = 0;
            } else if (menuItems[item].classList.contains(
              'hidden')) {
